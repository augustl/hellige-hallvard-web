...
export const paschaCycle: [PaschaCycleEntry & {label: string}, PaschaCycleEntry, PaschaCycleEntry, PaschaCycleEntry, PaschaCycleEntry, PaschaCycleEntry, PaschaCycleEntry][] = [
            ...
            labelledItems: [
                {
                    label: "6. time",
                    texts: [
                        {book: "Is", chunks: [{from: [48, 17], to: [49, 4]}]},
                    ]
                },
                {
                    label: "Vesper",
            ...
            labelledItems: [
                {
                    label: "6. time",
                    texts: [
                        {book: "Is", chunks: [{from: [49, 6], to: [49, 10]}]},
                    ]
                },
                {
                    label: "Vesper",
            ...
            labelledItems: [
                {
                    label: "6. time",
                    texts: [
                        {book: "Is", chunks: [{from: [58, 1], to: [58, 11]}]},
                    ]
                },
                {
                    label: "Forutinnviede gavers liturgi",
                    texts: [
                        {book: "Prov", chunks: [{from: [21, 23], to: [22, 4]}]},
                    ]
                }
            ...
            labelledItems: [
                {
                    label: "6. time",
                    texts: [
                        {book: "Is", chunks: [{from: [65, 8], to: [65, 16]}]},
                    ]
                },
                {
                    label: "Vesper",
            ...
            labelledItems: [
                {
                    label: "Matutin",
                    texts: [
                        {book: "Mt", chunks: [{from: [21, 18], to: [21, 43]}]},
                    ]
                },
                {
                    label: "6. time",
                    texts: [
                        {book: "Ezek", chunks: [{from: [1, 1], to: [1, 20]}]}
                    ]
                },
                {
                    label: "Vesper",
                ...
                },
                {
                    label: "Forutinnviede gavers liturgi",
                    texts: [
                        {book: "Mt", chunks: [{from: [24, 3], to: [24, 35]}]}
                    ]
                }
            ...
            labelledItems: [
                {
                    label: "Matutin",
                    texts: [
                        {book: "Mt", chunks: [{from: [22, 15], to: [23, 39]}]},
                    ]
                },
                {
                    label: "6. time",
                    texts: [
                        {book: "Ezek", chunks: [{from: [1, 21], to: [2, 1]}]}
                    ]
                },
                {
                    label: "Vesper",
    ...
    [
        {
            ...
            liturgyTexts: [
                {book: "Acts", chunks: [{from: [11, 19], to: [11, 26]}, {from: [11, 29], to: [11, 30]}]},
    ...
    [
        ...
        {
            texts: [
                {book: "Rom", chunks: [{from: [2, 28], to: [3, 8]}]},
                {book: "Mt", chunks: [{from: [6, 31], to: [6, 34]}, {from: [7, 9], to: [7, 11]}]}
            ]
        },
        null,
        null,
